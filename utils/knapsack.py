...
class Knapsack:
    ...
    def get_profit_given_items(self, items: np.array):
        """
        Get the profits of the current knapsack given a different set of item choices.
        """
        penalties = items @ (self._penalties @ items.T) / 2
